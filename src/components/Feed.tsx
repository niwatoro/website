...
export const Feed: FC = () => {
  return (
    <div className="h-full w-full bg-white md:flex">
      <div className="md:pb-28 pt-14 px-14 md:flex flex-col justify-between md:w-1/3 h-1/3 md:h-full">
      ...
      <div className="md:w-2/3 md:flex h-2/3 md:h-full">
        ...
        <div className="md:w-1/2 h-1/2 md:h-full border-t-8 border-black md:border-none">
